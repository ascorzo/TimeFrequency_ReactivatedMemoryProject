...
% save(strcat(savepath,'OdorDvsVehicle_FreqGeneralization_[-1,5]'),'cf_Generalization','resultGeneralization');
...
% savepath = '/mnt/disk1/andrea/German_Study/Time_Frequency_FT/TF_Calculation_90SecTrial/';
% save(strcat(savepath,'OdorMvsVehicle_FreqGeneralization_[-1,5]'),'cf_Generalization','resultGeneralization');
...
savepath = '/mnt/disk1/andrea/German_Study/Time_Frequency_FT/TF_Calculation_90SecTrial/';
save(strcat(savepath,'OdorDvsOdorM_FreqGeneralization_[-1,5]'),'cf_Generalization','resultGeneralization');