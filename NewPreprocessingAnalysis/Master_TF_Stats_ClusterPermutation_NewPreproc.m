...
for subj = 1:numel(filesOdor)
    ...
    Temp.Time_Freq_Odor = rmfield(Temp.Time_Freq_Odor,'trialinfo');
    OdorD_Allsubj{subj} = ft_selectdata(cfg, Temp.Time_Freq_Odor);
...
for subj = 1:numel(filesOdor)
    ...
    Temp.Time_Freq_Odor = rmfield(Temp.Time_Freq_Odor,'trialinfo');
    OdorM_Allsubj{subj} = ft_selectdata(cfg, Temp.Time_Freq_Odor);
