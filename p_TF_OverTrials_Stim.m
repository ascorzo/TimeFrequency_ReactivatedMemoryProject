...
filesOdor = dir(strcat(filepath,'*NewCycles*_Odor.mat'));
filesVehicle = dir(strcat(filepath,'*NewCycles*_Vehicle.mat'));
...
for subj = 1:numel(filesOdor)
    ...
    save(strcat(savepath,'NewCycles_TF_DNight_TFSlope'),...
...
for subj = 1:numel(filesOdor)
    ...
    save(strcat(savepath,'NewCycles_TF_MNight_TFSlope'),...
        'Time_Freq_Odor_Slope','Time_Freq_Vehi_Slope')
