...
for cluster = 1:numel(clusters)
    ...
    ValidTimeCue = v_time(~isnan(Time_Freq_Cue_subj_clust.(clusters{cluster})(1,1,:)));
    ValidTimeVehicle = v_time(~isnan(Time_Freq_Vehicle_subj_clust.(clusters{cluster})(1,1,:)));
