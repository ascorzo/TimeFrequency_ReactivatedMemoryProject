...
gen_Variable = 1:size(Time_Freq_VehicleAll.powspctrm,2);

savepath = '/mnt/disk1/andrea/German_Study/Time_Frequency_FT/TF_Calculation_90SecTrial/';
save(strcat(savepath,'OdorDvsVehicle_ChanGeneralization_[-1,5]_SuperSubj'),'cf_Generalization','resultGeneralization','gen_Variable');
...
savepath = '/mnt/disk1/andrea/German_Study/Time_Frequency_FT/TF_Calculation_90SecTrial/';
save(strcat(savepath,'OdorMvsVehicle_ChanGeneralization_[-1,5]_SuperSubj'),'cf_Generalization','resultGeneralization','gen_Variable');
...
savepath = '/mnt/disk1/andrea/German_Study/Time_Frequency_FT/TF_Calculation_90SecTrial/';
save(strcat(savepath,'OdorDvsOdorM_ChanGeneralization_[-1,5]_SuperSubj'),'cf_Generalization','resultGeneralization','gen_Variable');